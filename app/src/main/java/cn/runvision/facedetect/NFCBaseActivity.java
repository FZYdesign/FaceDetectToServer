...
public class NFCBaseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ip = Utils.getIp(NFCBaseActivity.this);
        port = Utils.getPort(NFCBaseActivity.this);
        account = Utils.getAccount(NFCBaseActivity.this);
        String source = Utils.getPassword(NFCBaseActivity.this);
