...
public class FaceLoginActivity extends Activity implements 
        SurfaceHolder.Callback, PreviewCallback, RecognizeListener,
        SeekBar.OnSeekBarChangeListener{
    private final static String TAG = "FaceLoginActivity";
   ...
   // private ImageView  imageMould;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 添加人脸框
        mDraw = new DrawCaptureRect(FaceLoginActivity.this, getResources().getColor(
                R.color.face_rect));
    ...
    private Handler handler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			switch (msg.what)
			{
				...
				case 1:
					//save account
					SharedPreferences settings = getSharedPreferences("useraccount",FaceLoginActivity.MODE_PRIVATE);
					Editor editor = settings.edit();//获取编辑器
					editor.putString("account", Login.username);
					editor.commit();//提交修改
				...
				//人脸登录失败
				case 2:
					toast= Toast.makeText(getApplicationContext(), "人脸登录失败!", Toast.LENGTH_SHORT);
					startFace();
					break;
					//人脸登录超时
				case 3:
					Log.e("111111111", "getApplicationContext");
	 ...
	 private void UserFaceAuth()
	   {
		   if(FaceNative.getPictureFaceFlag() == 1)
			{
				stopFace();
				
				progressBar.setVisibility(View.VISIBLE);
				FaceNative.UserFaceAuth(WelcomeActivity.name.getBytes(), MyApplication.sMac.getBytes());
				//FaceNative.UserAuth("test".getBytes(), "123456".getBytes());
				new Thread() {
					@Override
					public void run() {
