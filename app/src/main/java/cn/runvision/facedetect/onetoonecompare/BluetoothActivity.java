...
import cn.runvision.utils.ClsUtils;
import cn.runvision.utils.PreferData;
import cn.runvision.facedetect.BTReadIDCardActivity;
import cn.runvision.facedetect.view.OkOnlyDialog;
...
public class BluetoothActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.runvision.facedetect.R.layout.activity_device);
		pairedListView = (ListView) findViewById(cn.runvision.facedetect.R.id.paired_devices);
	...
	private void initData() {
		...
		search_button = (Button) findViewById(cn.runvision.facedetect.R.id.btn_search);
	...
	private void newBt(){
		mmNewDevicesArrayAdapter = new ArrayAdapter<String>(this, cn.runvision.facedetect.R.layout.newdevice_item);
		ListView newDevicesListView = (ListView) findViewById(cn.runvision.facedetect.R.id.new_devices);
...
//					ClsUtils.cancelPairingUserInput(device.getClass(), device);
	...
	public void listPairedBT() {
		...
		mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, cn.runvision.facedetect.R.layout.device_item);
		
		ListView pairedListView = (ListView) findViewById(cn.runvision.facedetect.R.id.paired_devices);
		pairedListView.setAdapter(mAdapter);
	...
	/*	mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.device_item01);
		...
		*/
		...
		if (pairedDevices.size() > 0) {
			findViewById(cn.runvision.facedetect.R.id.title_paired_devices).setVisibility(View.VISIBLE);
		...
		public void onReceive(Context context, Intent intent) {
		 ...
		 void doStateChange(Intent intent) {  
		        ...
		        case BluetoothDevice.BOND_NONE:  
		        	Log.d(TAG,"取消配对");
		        	//Toast.makeText(BluetoothActivity.this,"取消配对",Toast.LENGTH_SHORT);
		            break;  
		        case BluetoothDevice.BOND_BONDING:  
		        	Log.d(TAG,"正在配对");
		        	//Toast.makeText(BluetoothActivity.this,"配对成功",Toast.LENGTH_SHORT);
		            break;
		        case BluetoothDevice.BOND_BONDED:  
		        	Log.d(TAG,"完成配对");
		        	//Toast.makeText(BluetoothActivity.this,"完成配对",Toast.LENGTH_SHORT);
	...
	private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			Intent intent = new Intent(mContext, BTReadIDCardActivity.class);
	...
	class MyDetailAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(cn.runvision.facedetect.R.layout.device_item, null);
				holder = new ViewHolder();
				
				holder.name = (TextView) convertView
						.findViewById(cn.runvision.facedetect.R.id.device_name);
